...
const License: NextPage = () => (
  <Layout title="Mozilla Public License">
    <Section title="Mozilla Public License" subtitle="Version 2.0">
      ...
      <h3 id="license-grants-and-conditions">
      ...
      <h4 id="distribution-of-executable-form">
      ...
      <h4 id="distribution-of-a-larger-work">
      ...
      <h4 id="application-of-additional-terms">
      ...
      <h3 id="inability-to-comply-due-to-statute-or-regulation">
      ...
      <h4 id="distributing-source-code-form-that-is-incompatible-with-secondary-licenses">
      ...
      <h3 id="exhibit-a---source-code-form-license-notice">
      ...
      <h3 id="exhibit-b---incompatible-with-secondary-licenses-notice">
